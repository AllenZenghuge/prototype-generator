...
| 文档 | 路径 | 状态 |
|------|------|------|
| 设计概要（完整规范） | `myapp/素材提取/06-前端重设计/20260621_v2.0_前端重设计概要.md` | ⚠️ 色彩/材质值为增强前初版，已过时 |
| 23 个 mockup | `myapp/素材提取/06-前端重设计/mockups/` | ✅ 权威设计来源 |
| 变更记录 | `myapp/素材提取/01-设计/20260621_v1.1_变更记录.md` | ✅ v1.1 准确 |
| 设计决策记录 | `myapp/素材提取/01-设计/20260614_v1.0_设计决策记录.md` | ❌ 缺失 v2.0 决策（17~23） |
...
└── 06-前端重设计/                 ← v2.0 设计定稿
    ├── 20260621_v2.0_前端重设计概要.md  ← ⚠️ 色彩/材质值为初版，非最终增强版
...
| v2.0 设计决策写入决策记录 | ❌ | 决策 17~23 待补充 |
| v2.0 设计概要更新 | ❌ | 色彩/材质值为初版，需更新为增强版 |
